...
{
    [SerializeField] private ShopItemView _heroSkinItemPrefab;

    public ShopItemView Get(ShopItem shopItem, Transform parent)
    {
        ShopItemVisitor visitor = new ShopItemVisitor(_heroSkinItemPrefab);
    ...
    {
        private ShopItemView _heroSkinItemPrefab;

        public ShopItemVisitor(ShopItemView heroSkinItemPrefab)
        {
            _heroSkinItemPrefab = heroSkinItemPrefab;
        }
        ...
        public void Visit(HeroSkinItem characterSkinItem) => Prefab = _heroSkinItemPrefab;
    }
}
